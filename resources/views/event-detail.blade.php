...
<main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-32">
                <!-- DINAMIS: Menampilkan gambar poster dari folder storage -->
        ...
        <div class="lg:col-span-2 space-y-12">
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-6 text-slate-500 font-medium">
                    <div class="flex items-center gap-2">
                        ...
                        <!-- DINAMIS: Mengubah Format Tanggal -->
            ...
            <div class="prose prose-slate max-w-none">
                ...
                <!-- DINAMIS: Mengubah Deskripsi Acara -->
            ...
            <div class="bg-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl shadow-indigo-200 relative overflow-hidden">
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div>
                        ...
                        <!-- DINAMIS: Mengubah Format Harga Tiket Rupiah -->
                        ...
                        <p class="mt-4 text-indigo-100 flex items-center gap-2">
                            ...
                            <!-- DINAMIS: Mengubah Angka Sisa Stok -->
                            Sisa stok: <span class="font-bold underline">{{ $event->stock }} Tiket lagi!</span>
                        </p>
                    </div>
                    <div>
                        <!-- DINAMIS: Mengubah tautan tombol checkout sesuai parameter id event -->
