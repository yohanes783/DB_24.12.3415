...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <a href="/admin/partners" class="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-indigo-600 transition">
    ...
    <!-- Kotak Utama Formulir (Grid 2 Kolom) -->
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden grid grid-cols-1 md:grid-cols-3">
        ...
        <div class="p-8 md:col-span-2 border-b md:border-b-0 md:border-r border-slate-100">
            <h3 class="text-lg font-bold text-slate-900 mb-1">Tambah Partner Baru</h3>
            <p class="text-xs text-slate-400 mb-6">Tambahkan partner atau sponsor baru untuk event Anda.</p>
            ...
            <form action="/admin/partners" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-slate-400 mt-1.5">Gunakan URL gambar/logo partner dari internet.</p>
                </div>
        ...
        <!-- SISI KANAN: Real-time Box Preview Logo -->
        <div class="p-8 bg-slate-50/50 flex flex-col items-center justify-center text-center">
            ...
            <p class="text-xs text-slate-400 mt-4 max-w-[180px]">Ketikkan URL gambar di sebelah kiri untuk melihat pratinjau secara langsung.</p>
        </div>
